 ...
 * До гидратации атрибут выставляет инлайн-скрипт в layout.tsx.
 * Скопирован из web (admin — отдельное приложение, общий ключ хранилища).
 */
...
/** Ключ в localStorage (дублируется в инлайн-скрипте layout.tsx). */
