...
// Источник: packages/design/shared/BrandMark.tsx
 ...
 * currentColor: на тёмной шапке/сайдбаре марка автоматически становится белой
 * (text-surface-light), красная M остаётся брендовой.
 * Статическая копия для внешнего использования — web/public/brand/mark.svg.
 */
...
type BrandMarkProps = {
   ...
   * поверх фотографии на странице входа консоли).
   */
  monochrome?: boolean;
};
