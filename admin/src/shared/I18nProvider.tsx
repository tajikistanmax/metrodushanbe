...
// Источник: packages/design/shared/I18nProvider.tsx
// Изменения вносите в источник и запускайте: node packages/design/sync.mjs
/**
 * React-контекст языка интерфейса.
 * - default: tg; выбор сохраняется в localStorage (общий ключ у портала и консоли);
 ...
 *
 * Словари НЕ общие: `@/lib/i18n` резолвится в каждом приложении в свой модуль
 * (у портала и консоли разные наборы строк). Общий здесь только механизм.
 */
