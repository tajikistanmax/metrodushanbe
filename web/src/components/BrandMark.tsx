 ...
 * currentColor: на тёмной шапке марка автоматически становится белой
 * (text-surface-light), красная M остаётся брендовой.
 * Статическая копия для внешнего использования — public/brand/mark.svg.
 */
...
type BrandMarkProps = {
   ...
   * на navy-шапке — var(--brand-navy), чтобы сохранить рисунок пути.
   */
  holeColor?: string;
};
