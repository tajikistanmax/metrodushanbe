...
// Источник: packages/design/shared/ThemeToggle.tsx
// Изменения вносите в источник и запускайте: node packages/design/sync.mjs
/**
 * Переключатель темы: одна кнопка, три состояния по кругу
 * auto → light → dark → auto. Иконки — inline SVG (без внешних ресурсов).
 *
 * Доступность: состояние передаётся не только иконкой — aria-label и title
 * содержат текущий режим словами («Тема: тёмная»).
 */
